...
from MetaSpace.src.meta_space.classical_distances import compute_classical_distances
from MetaSpace.src.meta_space.golden_tools import load_golden_as_df

# === tes imports existants (features) ===
from MetaSpace.src.meta_space.spectral_features import compute_spectral_metrics_for_all
from MetaSpace.src.meta_space.syntax_string_features import compute_syntax_string_features
from MetaSpace.src.meta_space.topology_features import compute_topological_metrics, vector_to_point_cloud
...
def run_for_dataset(
    ...
    out_dir: str | Path = HERE.parent[3] / "MetaSpace/tests/results_meta_space",
    n_samples_per_col: int = 20,
...
if __name__ == "__main__":
    ...
    _ = run_for_dataset(
        ...
        out_dir=HERE.parent[3] / "MetaSpace/tests/results_meta_space",
