---
noteId: "1e1c3bb0b70d11f0b0c5b7e912451ee4"
tags: []

---

# MetaSpace — Supervised Schema Matching with a Meta-Space of Features

[![version](https://img.shields.io/github/v/release/your-org/MetaSpace?style=for-the-badge&logo=github)](#)
[![lint](https://img.shields.io/github/actions/workflow/status/your-org/MetaSpace/lint.yml?label=lint&style=for-the-badge&logo=github)](#)
[![build](https://img.shields.io/github/actions/workflow/status/your-org/MetaSpace/build.yml?label=build&style=for-the-badge&logo=github)](#)
[![test](https://img.shields.io/github/actions/workflow/status/your-org/MetaSpace/test.yml?label=test&style=for-the-badge&logo=github)](#)
[![codecov](https://img.shields.io/codecov/c/github/your-org/MetaSpace?style=for-the-badge&logo=codecov)](#)
...
> **MetaSpace: Supervised Schema Matching for Heterogeneous Tabular Data using Meta-Space**  


MetaSpace treats schema matching as **supervised learning** in a **meta-space** that blends:
...
1. **`MetaSpace`** — builds the **meta-features** for all **S1×S2** attribute pairs and attaches labels from a **golden JSON**.
...
- **Baselines (RQ5):** MetaSpace is competitive vs. classical and LLM-aided baselines (Coma/Cupid/Magneto variants) reported in our study.
...
```bash
git clone https://github.com/user28060/MetaSpace.git
cd MetaSpace
...
├── src/
│   ├── meta_space/
│   │   ├── pipeline.py              # CLI: MetaSpace (build features from S1×S2)
│   │   ├── embed_utils.py
│   │   ├── golden_tools.py
│   │   └── meta_features/
